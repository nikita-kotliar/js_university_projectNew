import{i as m}from"./vendor-I1I71QQ2.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(r){if(r.ep)return;r.ep=!0;const i=t(r);fetch(r.href,i)}})();const u="favourite",F=e=>{localStorage.setItem(u,JSON.stringify(e))},b=e=>{try{return JSON.parse(localStorage.getItem(e))}catch(s){console.log(s.message)}},C=e=>{const s=b(u).filter(t=>t._id!==e);localStorage.removeItem(u),localStorage.setItem(u,JSON.stringify(s))},_=window.location.pathname,j=document.getElementById("homeLink"),$=document.getElementById("favoritesLink");j.classList.remove("active");$.classList.remove("active");_.includes("index.html")?j.classList.add("active"):_.includes("favorites.html")&&$.classList.add("active");const M=document.querySelector(".open-mobile-menu-btn"),A=document.querySelector(".close-mobile-menu-btn"),k=document.querySelector(".mobile-menu-wrapper");M.addEventListener("click",function(){k.classList.add("is-open"),document.body.classList.add("not-scrollable")});A.addEventListener("click",function(){k.classList.remove("is-open"),document.body.classList.remove("not-scrollable")});const n={cardSet:document.querySelector(".fav_card_list"),noCards:document.querySelector(".no_cards_wrapper"),quoteContainer:document.querySelector(".quote"),noCardsContainer:document.querySelector(".no_cards_wrapper-container"),paginationCards:document.querySelector(".pagination-cards")};let f=1;const y=8,T=(e,s)=>{const t=(s-1)*y,o=t+y;return e.slice(t,o)},R=(e=[])=>{const s=new Set;return e.filter(t=>!(t!=null&&t._id)||s.has(t._id)?!1:(s.add(t._id),!0))},S=e=>{const s=e.map(({name:t,_id:o,burnedCalories:r,bodyPart:i,target:a,time:P=3})=>{let L=`${r} / ${P} min`,w=i,x=a;return t.length>32&&(t=t.slice(0,26)+"..."),window.innerWidth<1440&&(t.length>24&&(t=t.slice(0,20)+"..."),w="...",x="..."),window.innerWidth<768&&(L=`${r} /... min`,t.length>22&&(t=t.slice(0,18)+"...")),`
      ...
      `}).join("");n.cardSet.innerHTML=s},O=e=>{const s=e.target.closest('[data-action="start_exercise_btn"]'),t=e.target.closest('[data-action="delete_fav_card"]');if(!(!s&&!t)){if(t){C(t.dataset.idDelBtn),v();return}if(s){const r=(b(u)||[]).find(i=>i._id===s.dataset.idStartBtn);r&&X(r,!0,!0)}}};n.cardSet&&n.cardSet.addEventListener("click",O);function H(e){if(n.paginationCards){if(e<=1){n.paginationCards.innerHTML="";return}n.paginationCards.innerHTML=Array.from({length:e},(s,t)=>`
      <li>
        <button
          name="pagination"
    ...
    </div>`;l.innerHTML=o;const r=document.querySelectorAll(".star-rating-icon");for(let a=0;a<Math.round(e.rating);++a)r[a].style.fill="#eea10c";const i=document.querySelector(".add-favourite-btn");i.addEventListener("click",function(){d?(C(e._id),i.innerHTML=`Add to favourite
          <svg class="heart-icon" width="20px" height="20px">
            <use href="/js_university_projectNew/symbol-defs.svg#icon-heart"></use>
...
//# sourceMappingURL=exercises_card-QJvDtgA3.js.map
